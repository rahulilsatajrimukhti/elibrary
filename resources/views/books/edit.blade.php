                                ...
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="number" name="publish_year"
                                            value="{{ old('publish_year', $data->publish_year) }}"
                            ...
                            <div class="card border shadow-sm">
                                ...
                                <div class="card-body">
                                    ...
                                    <div id="coverContainer"
                                        ...
                                        {{-- EMPTY --}}
                                        <div id="emptyCover" class="text-center {{ $data->cover ? 'd-none' : '' }}">
                                        ...
                                        {{-- PREVIEW --}}
                                        <img id="coverPreview" src="{{ $data->cover ? Storage::url($data->cover) : '' }}"
                                            class="img-fluid rounded {{ $data->cover ? '' : 'd-none' }}"
